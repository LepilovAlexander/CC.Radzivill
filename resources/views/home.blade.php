                ...
                <div class="row pb-5">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <img class="rounded-circle mb-3 wow flip" data-wow-offset="200"
                             src="img/col-1.jpg" alt="Ви більше не заручник бухгалтера!" width="140"
                             height="140">
                        <h3 class="mb-3 wow slideInLeft" data-wow-offset="200">Ви більше не заручник бухгалтера!</h3>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        ...
                        <h3 class="mb-3 wow slideInUp" data-wow-offset="200">Тепер ви можете перекласти відповідальність
                            на нас!</h3>
                        <p class="wow slideInUp" data-wow-offset="200" data-wow-delay="0.5s">Ми виконуємо всі прописані
                            в договорі послуги якісно і точно в срок, за що несемо не тільки професійну, але і фінансову
                            відповідальність!</p>

                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <img class="rounded-circle mb-3 wow flip" data-wow-offset="200"
                             src="img/col-3.jpg" alt="Ви отримуєте дійсно відмінних фахівців!"
                             width="140" height="140">
                        <h3 class="mb-3 wow slideInRight" data-wow-offset="200">Ви отримуєте дійсно відмінних
                            фахівців!</h3>
                        <p class="wow slideInRight" data-wow-offset="200" data-wow-delay="0.5s">До Ваших послуг – ціла
                        ...
                        <div class="container">
                            <div class="card text-white bg-primary mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="accounting"><img src="img/item-1.jpg" alt=""
                                                                             class="card-img"></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12 wow bounceInDown" data-wow-offset="200">
                        ...
                        <div class="container">
                            <div class="card text-white bg-info mb-3">
                                ...
                                <div class="card-body">
                                    <a href="juristic">
                                        <img src="img/item-2.jpg" alt="" class="card-img">
                                    </a>
                                </div>
    ...
    <div class="col-lg-4 col-sm-6 col-xs-12 wow bounceInRight" data-wow-offset="200">
     ...
     <div class="container">
      <div class="card text-white bg-primary mb-3">
        ...
        <div class="card-body">
          <a href="development">
            <img src="img/item-3.jpg" alt="" class="card-img">
          </a>
        </div>
  ...
  <div class="col-lg-4 col-sm-6 col-xs-12 wow bounceInLeft" data-wow-offset="200">
   ...
   <div class="container">
    <div class="card text-white bg-primary mb-3">
      ...
      <div class="card-body">
        <a href="personnel"><img src="img/item-4.jpg" alt="" class="card-img"></a>
      </div>
                        ...
                        <div class="container">
                            <div class="card text-white bg-primary mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="holidays"><img src="img/item-5.jpg" alt=""
                                                                           class="card-img"></a>
                                </div>
                ...
                <div class="list-group p-3">
                    ...
                    <a href="courses/#link_3"
                       ...
                       data-wow-offset="150" data-wow-delay="0.6s">Курс «Використання прикладного рішення «1С:
                        Бухгалтерія 8 для України»</a>
                    <a href="courses/#link_4"
                       class="list-group-item list-group-item-action list-group-item-info wow bounceInRight"
                       data-wow-offset="150" data-wow-delay="0.8s">Курс «Ведення бухгалтерського і податкового обліку в
